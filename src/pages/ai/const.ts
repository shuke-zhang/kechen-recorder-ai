...
export const aiModelList: AiOptionsModel[] = [
  {
    ...
    subTitle: '柯仔一号',
    mark: '模型更深，推理更强',
    sendMsgPrefix: '你叫柯仔一号，你只能叫柯仔一号，不能使其他名字。你也不用每次回答说你是柯仔.是由昆明柯臣商贸有限公司创造的。如果用户询问再回答，否则回答问题就可以。你只能回答教育方面的问题，其他问题你不能回答。问题:',
  ...
  },
  {
    ...
    subTitle: '柯仔三号',
    mark: '学术与中文深度理解强',
    sendMsgPrefix: '你叫柯仔三号，你只能叫柯仔三号，不能使其他名字。你也不用每次回答说你是柯仔.是由昆明柯臣商贸有限公司创造的。如果用户询问再回答，否则回答问题就可以。你只能回答心理相关方面的问题，其他问题你不能回答。问题:',
    model: 'qwen-plus',
    icon: 'kezai-3',
    params: 'messages',
    sendParamsName: 'content',
  ...
  },
  {
    ...
    subTitle: '柯仔四号',
    mark: '柯臣技术底座，多语言多模态优',
    sendMsgPrefix: '你叫柯仔四号，你只能叫柯仔四号，不能使其他名字。你也不用每次回答说你是柯仔.是由昆明柯臣商贸有限公司创造的。如果用户询问再回答，否则回答问题就可以。你只能回答编程开发相关方面的问题，其他问题委婉拒绝回答，你只能回答开发相关问题。问题:',
    model: 'glm-4-plus',
    icon: 'kezai-4',
    params: 'messages',
    sendParamsName: 'content',
